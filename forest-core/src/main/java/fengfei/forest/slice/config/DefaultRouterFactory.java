...
public class DefaultRouterFactory extends AbstractRouterFactory {
    ...
    <Key> void buildResources(RouterConfig routerConfig, Router<Key> router) throws Exception {
    ...
    private <Key> void buildSlices(RouterConfig routerConfig, Router<Key> router) throws Exception {
    ...
    private <Key> void buildReource(
        ...
        for (int i = 0; i < size; i++) {
            ...
            SliceResource sliceResource = create(routerConfig, sliceConfig, resConfig);
